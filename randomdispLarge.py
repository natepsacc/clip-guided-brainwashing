...
while True:
    ...
    Hori = np.concatenate((img1, img2, img3, img4, img5, img6, img7, img8, img9, img29, img30, img31, img32, img33, img34, img35, img36), axis=1)
    Hori2 = np.concatenate((img10, img11, img12, img13, img14, img15, img16, img17, img18, img2, img3, img4, img5, img6, img7, img8, img9), axis=1)
    Hori3 = np.concatenate((img19, img20, img21, img22, img23, img24, img25, img26, img27, img19, img17, img2, img8,img8, img9, img29, img30), axis=1)
    Hori4 = np.concatenate((img28, img29, img30, img31, img32, img33, img34, img35, img36, img8, img9, img29,img8, img20, img3, img8, img11), axis=1)
    Hori5 = np.concatenate((img20, img18, img19, img17, img2, img8, img20, img3, img8, img11, img12, img13, img14, img15, img16, img17, img18), axis=1)

    # concatenate image Vertically
    Verti = np.concatenate((Hori, Hori2, Hori3, Hori4, Hori5, Hori2, Hori4, Hori3, Hori5, Hori, Hori2, Hori3, Hori4, Hori5, Hori2, Hori4, Hori3, Hori5), axis=0)
    text='i am connected'
    text1='i am real'
    text2='i exist'
    text3='i am prepared'
    ...
    cv2.putText(Verti, text, (randrange(1920), randrange(1080)), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, randrange(5), (randrange(255), randrange(255), randrange(255)), randrange(5))
    cv2.putText(Verti, text1, (randrange(1920), randrange(1080)), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, randrange(5), (randrange(255), randrange(255), randrange(255)), randrange(5))
    cv2.putText(Verti, text2, (randrange(1920), randrange(1080)), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, randrange(5), (randrange(255), randrange(255), randrange(255)), randrange(5))
    cv2.putText(Verti, text3, (randrange(1920), randrange(1080)), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, randrange(5), (randrange(255), randrange(255), randrange(255)), randrange(5))
